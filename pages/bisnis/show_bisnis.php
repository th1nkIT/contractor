    ...
    <!-- Konten Bisnis Start -->
        <section class="page">
            <!-- Konten Bisnis Start -->
                    ...
                    <div class="ct">
                        ...
                        <div class="ct-main">
                            <!-- Deskripsi Content Start -->
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid ullam quam quae obcaecati nisi, error quod reiciendis quos consequatur excepturi? Ipsam aliquid sed fugit repudiandae illo placeat beatae quo tenetur? Itaque amet magnam saepe. Laborum, unde aspernatur labore dignissimos autem similique fugiat eos accusantium odio possimus optio maiores quibusdam impedit.</p>
                ...
                <!-- Button Start -->
                    <div class="ct-btn">
                        <a href="#">KONSTRUKSI SIPIL</a>
                        <a href="#">ARSITEKTUR</a>
                        <a href="#">ELEKTRIKAL</a>
                        <a href="#">MEKANIKAL</a>
                        <a href="#">REKONSTRUKSI PROYEK</a>
                        <a href="#">KONTRAKTOR UMUM</a>
                    </div>
                <!-- Button End -->
            <!-- Konten Bisnis End -->
        </section>
