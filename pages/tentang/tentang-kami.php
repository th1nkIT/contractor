            ...
            <div class="navbars-konten">
                ...
                <!-- Nav Start -->
                    <div class="navbars-nav">
                        ...
                        <div class="drop">
                            <a class="aktif" href="#">TENTANG KAMI <i class="bi-chevron-down"></i></a>
                            <ul>
                                <li><a class="aktif" href="tentang-kami.php">Tentang Kami</a></li>
    ...
    <!-- Konten Section Start -->
        <!-- Button Galeri Start -->
            <section class="btn-gallery">
                <a href="galeri.php">GALERI <i class="bi-chevron-double-right"></i></a>
            </section>
        <!-- Button Galeri End -->
